...
### yml files are cool
### Started writing my own Spring properties CRUD, then I found out about actuators and http://.../env, /health, etc
### Docker Toolbox uses Virtualbox but they have Docker for Windows that uses Hyper-V!  Needs Windows Pro tho ($99), but Hyper-V looks cool as it uses hardware directly!  Maybe it would speed up my own Linux development with the RemoteFX (3d acceleration stuff)?
### Started running Main.java directly from Eclipse, was a lot faster and debugging was easier to setup

## Frustrations
### Gradle
No auto-refresh of dependencies in IntelliJ when adding dependencies to build.gradle file

## Seths Thoughts as he did this project
